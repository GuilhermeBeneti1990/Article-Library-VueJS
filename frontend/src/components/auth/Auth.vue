<template>
    <div class="auth-content">
        <div class="auth-modal">
            ...
            <input v-show="showSignup" type="text" v-model="user.name" placeholder="Name...">
            <input type="text" v-model="user.email" placeholder="E-mail...">
            <input type="password" v-model="user.password" placeholder="Password...">
            <input v-show="showSignup" type="password" v-model="user.confirmPassword" placeholder="Confirm your Password please...">

            <button v-if="showSignup" @click="signup">Register</button>
            <button v-else @click="signin">Enter</button>

            <a href @click.prevent="showSignup = !showSignup">
                <span v-if="showSignup">Already have a account? So login here!</span>
                <span v-else>No is registered? Register here!</span>
            </a>
        </div>
    </div>
</template>
