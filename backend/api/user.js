...
module.exports = app => {
    ...
    const save = async (req, res) => {
        ...
        try {
            ...
            existsOrError(user.confirmPassword, 'Please confirm your password')
    ...
    const getById = (req, res) => {
        app.db('users').select('id', 'name', 'email', 'admin').where({ id: req.params.id }).whereNull('deletedAt').first()
